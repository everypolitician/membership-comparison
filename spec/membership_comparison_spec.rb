...
describe MembershipComparison do
  ...
  context 'no existing P39s' do
    ...
    specify { expect(problems).to be_empty }
  end
  ...
  context 'existing base P39s' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to match_array(['wds:1030-1DAA-3101', 'wds:1030-1DAA-3102']) }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3101']).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3102']).to be_empty }
  end
  ...
  context 'single existing P39, previous term' do
    ...
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3100']).to be_empty }
  end
  ...
  context 'single existing P39, exact match' do
    ...
    specify { expect(exact_matches).to match_array(['wds:1030-1DAA-3101']) }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3101']).to be_empty }
  end
  ...
  context 'multiple existing P39s, historic exact match' do
    ...
    specify { expect(exact_matches).to match_array(['wds:1030-1DAA-3100']) }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3100']).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3101']).to be_empty }
  ...
  context 'single existing P39, partial match' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to match_array(['wds:1030-1DAA-3102']) }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3102']).to be_empty }
  end
  ...
  context 'single existing P39, party conflict' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-3102']) }
    specify { expect(problems['wds:1030-1DAA-3102']).to match_array(['party conflict']) }
  end
  ...
  context 'single existing P39, district conflict' do
    ...
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-3102']) }
    specify { expect(problems['wds:1030-1DAA-3102']).to match_array(['district conflict']) }
  end
  ...
  context 'single existing P39, different position' do
    ...
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-4100']).to be_empty }
  end
  ...
  context 'single existing P39, without suggested party' do
    ...
    specify { expect(exact_matches).to match_array(['wds:1030-1DAA-3102']) }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3102']).to be_empty }
  end
  ...
  context 'existing dated P39, within term' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to match_array(['wds:1030-1DAA-3103']) }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3103']).to be_empty }
  end
  ...
  context 'existing dated P39 between terms' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to match_array(['wds:1030-1DAA-3104']) }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3104']).to be_empty }
  end
  ...
  context 'existing dated P39 spanning terms' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-3105']) }
    specify { expect(problems['wds:1030-1DAA-3105']).to match_array(['spanning terms']) }
  end
  ...
  context 'existing P39s, surrounding terms' do
    ...
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3140']).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3101']).to be_empty }
  end
  ...
  context 'existing P39s, surrounding and including terms' do
    ...
    specify { expect(exact_matches).to match_array(['wds:1030-1DAA-0041']) }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-0040']).to be_empty }
    specify { expect(problems['wds:1030-1DAA-0041']).to be_empty }
    specify { expect(problems['wds:1030-1DAA-0042']).to be_empty }
  end
  ...
  context 'existing P39s, surrounding and including dates' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to match_array(['wds:1030-1DAA-1041']) }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-1040']).to be_empty }
    specify { expect(problems['wds:1030-1DAA-1041']).to be_empty }
    specify { expect(problems['wds:1030-1DAA-1042']).to be_empty }
  end
  ...
  context 'member returns within term' do
    ...
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3106']).to be_empty }
  end
  ...
  context 'member returns within term (previous still open)' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-3107']) }
    specify { expect(problems['wds:1030-1DAA-3107']).to match_array(['previous term still open']) }
  end
  ...
  context 'existing dated P39, started before previous term ended' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-3104']) }
    specify { expect(problems['wds:1030-1DAA-3104']).to match_array(['previous term still open']) }
  end
  ...
  context 'existing statement, started during a term' do
    ...
    specify { expect(exact_matches).to match_array(['wds:1030-1DAA-3107']) }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to be_empty }
    specify { expect(problems['wds:1030-1DAA-3107']).to be_empty }
  end
  ...
  context 'when suggestied person is a disambiguation page' do
    ...
    specify { expect(exact_matches).to be_empty }
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-0042']) }
    specify { expect(problems['wds:1030-1DAA-0042']).to match_array(['person is a disambiguation']) }
  end
  ...
  context 'when suggestied party is a disambiguation page' do
    ...
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-0042']) }
    specify { expect(problems['wds:1030-1DAA-0042']).to match_array(['party is a disambiguation']) }
  end
  ...
  context 'when suggestied district is a disambiguation page' do
    ...
    specify { expect(partial_matches).to be_empty }
    specify { expect(conflicts).to match_array(['wds:1030-1DAA-0042']) }
    specify { expect(problems['wds:1030-1DAA-0042']).to match_array(['district is a disambiguation']) }
  end
end
